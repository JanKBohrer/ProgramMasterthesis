...
# in here, the generated grids/SIPs will be stored as a defined system state,
# which can then be loaded and simulated by cloud_MP.py
storage_path="/Users/bohrer/sim_data_cloudMP/"
sseed=4301 # SIP generation seed for the FIRST grid, seeds of other grids will be sseed+2, sseed+4, sseed+6, ...
Nsim=50 # number of generated grids
solute_type="AS"
no_spcm0=26 # number of super particles first mode
no_spcm1=38 # number of super particles second mode
